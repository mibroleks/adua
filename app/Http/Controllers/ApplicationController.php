...
class ApplicationController extends Controller
{
    ...
    /** Display the current status of an application + audit trail. */
    public function status(Application $application)
    {
        Gate::authorize('view', $application);

        $history = $application->statusHistories()->latest('changed_at')->get();
    ...
    public function exportExcel(Application $application)
    {
        ...
        return Excel::download(
            new \App\Exports\ApplicationExport($application),
